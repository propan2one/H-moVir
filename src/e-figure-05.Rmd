...
## Figure 5 A Matrix of the 116 variants which were major or minor according to the samples.
...
## Figure 5 B Dot plot of the 29 minor variants of Mo ind10 which are also found as major variants in Mo samples
...
## Figure 5 E Dot plot of the 85 minor variants of Mo ind3 which are also found as major variants in Mo ind4/10 and in all samples from Br and Th
...
## Figure 5 F The minor variant found in Mo ind3 at position 57,091 and 65,624 of the C-NR-genome corresponds to major variants other samples

### Figure 5 F position 57,091
...
Table4 %>%
  ...
  pivot_longer(c(-UniqueID, -Genome),
               names_to = "BASE", 
               values_to = "Frequency") %>%
  dplyr::filter(UniqueID == "65624_C>T")
```
